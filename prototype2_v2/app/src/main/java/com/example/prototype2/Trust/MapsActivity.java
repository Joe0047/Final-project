...
import com.example.prototype2.Geofence.GeofenceErrorMessage;
import com.example.prototype2.Geofence.GeofenceIntentService;
...
public class MapsActivity<BindView> extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    // Geofence 中心位置座標
    //private static final LatLng center = new LatLng(23.560786, 120.476059);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        center = getIntent().getExtras().getParcelable("Center");
    ...
    public void onLocationChanged(Location location) {
        ...
        // 移動地圖到目前位置
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(now, 17));
    }
